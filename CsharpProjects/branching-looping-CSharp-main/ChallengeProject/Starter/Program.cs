        ...
        case "3":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: " && ourAnimals[i, 2] == "Age: ?")
                {
                    do
                    {
                        Console.WriteLine($"Enter the pet's age for {ourAnimals[i, 0].ToString()}");
                        readResult = Console.ReadLine();
                        if (readResult != null)
                        {
                            animalAge = readResult;
                    ...
                    ourAnimals[i, 2] = "Age: " + animalAge;
                    Console.WriteLine($"pet's age for {ourAnimals[i, 0].ToString()} has been updated! \nPress Enter to continue.");
                    readResult = Console.ReadLine();
                }
                ...
                if (ourAnimals[i, 0] != "ID #: " && ourAnimals[i, 4] == "Physical description: ")
                {
                    do
                    {
                        Console.WriteLine($"Enter a valid physical description of the pet (size, color, gender, weight, housebroken) for {ourAnimals[i, 0].ToString()}");
                        readResult = Console.ReadLine();
                        if (readResult != null)
                        {
                            animalPhysicalDescription = readResult.ToLower();

                            if (animalPhysicalDescription == "") //<------set additional rules here
                                validEntry = false;
                            else
                                validEntry = true;
                        }
                    ...
                    Console.WriteLine($"pet's physical description for {ourAnimals[i, 0].ToString()} has been updated! \nPress Enter to continue.");
                    readResult = Console.ReadLine();
            ...
            Console.WriteLine("All animal ages and physical descriptions are complete!");
            Console.WriteLine("Press the Enter key to continue.");
            readResult = Console.ReadLine();
            break;
        ...
        case "4":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                if (ourAnimals[i, 0] != "ID #: " && (ourAnimals[i, 3] == "Nickname: " || ourAnimals[i, 3] == "Nickname: tbd"))
                {
                    do
                    {
                        Console.WriteLine($"Enter a valid Nickname for {ourAnimals[i, 0].ToString()}");
                        readResult = Console.ReadLine();
                        if (readResult != null)
                        {
                            animalNickname = readResult.ToLower();

                            if (animalNickname == "") //<------set additional rules here
                                validEntry = false;
                            else
                                validEntry = true;
                        }
                    ...
                    Console.WriteLine($"Nickname for {ourAnimals[i, 0].ToString()} has been updated! \nPress Enter to continue.");
                    readResult = Console.ReadLine();
                ...
                if (ourAnimals[i, 0] != "ID #: " && (ourAnimals[i, 5] == "Personality: " || ourAnimals[i, 5] == "Personality: tbd"))
                {
                    do
                    {
                        ...
                        if (readResult != null)
                        {
                            ...
                            if (animalPersonalityDescription == "") //<------set additional rules here
                                validEntry = false;
                            else
                                validEntry = true;
                        }
                    ...
                    Console.WriteLine($"Personality:  description for {ourAnimals[i, 0].ToString()} has been updated! \nPress Enter to continue.");
                    readResult = Console.ReadLine();
